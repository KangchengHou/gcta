...
public:
    ...
    void HE_reg(string grm_file, bool m_grm_flag, string phen_file, string keep_indi_file, string remove_indi_file, int mphen, bool no_std_phen = false, bool fit_full = false); // allow multiple regression
